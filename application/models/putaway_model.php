...
//        endif;
        ...
        $this->db->select(" STK_M_Location.Location_Id, STK_M_Location.Location_Code, STK_M_Location.Putaway_Id");
        $this->db->from("STK_M_Location");
        $this->db->join("STK_M_Zone", "STK_M_Zone.Zone_Id = STK_M_Location.Zone_Id AND STK_M_Zone.Active = 'Y'", "LEFT");
        $this->db->join("STK_M_Zone_Category", "STK_M_Zone_Category.Zone_Id = STK_M_Zone.Zone_Id AND STK_M_Zone_Category.Active = 'Y'", "LEFT");
...
// exit;
    ...
    public function get_putaway_list($Id = NULL, $column = NULL) {
        ...
        $this->db->join("SYS_M_Domain AS PROD", "PROD.Dom_ID = PA.Product_Status_Id AND PROD.Dom_Host_Code = 'PROD_STATUS' AND PROD.Dom_Active = 'Y'", "LEFT");
        $this->db->join("SYS_M_Domain AS PROD_SUB", "PROD_SUB.Dom_ID = PA.Product_Sub_Status_Id AND PROD_SUB.Dom_Host_Code = 'SUB_STATUS' AND PROD_SUB.Dom_Active = 'Y'", "LEFT");
        $this->db->join("SYS_M_Domain AS PROD_CATE", "PROD_CATE.Dom_ID = PA.Product_Category_Id AND PROD_CATE.Dom_Host_Code = 'PROD_CATE' AND PROD_CATE.Dom_Active = 'Y'", "LEFT");
        $this->db->join("STK_M_Zone AS ZONE", "ZONE.Zone_Id = PA.Zone_Id AND ZONE.Active = 'Y'", "LEFT");
        if ($Id !== NULL):
            $this->db->where("PA.Id", $Id);
        endif;
        $this->db->where("PA.Active", 'Y');
