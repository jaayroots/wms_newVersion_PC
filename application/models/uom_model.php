...
class Uom_model extends CI_Model {
    ...
    function get_uom_all() {
        ...
        $this->db->from("CTL_M_UOM");
        $this->db->join("CTL_M_UOM_Language", "CTL_M_UOM.id = CTL_M_UOM_Language.CTL_M_UOM_id AND CTL_M_UOM_Language.language = 'eng'");
//        $this->db->where("CTL_M_UOM.Active", ACTIVE); 
        $query = $this->db->get();
    ...
    function get_template_all() {
        ...
        $this->db->join("CTL_M_UOM_Template_Language", "CTL_M_UOM_Template.id = CTL_M_UOM_Template_Language.CTL_M_UOM_Template_id AND CTL_M_UOM_Template_Language.language = 'eng'");
        //$this->db->where("CTL_M_UOM.Active", ACTIVE); 
